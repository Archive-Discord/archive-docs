<template lang="pug">
    div.h-max
        ...
        hr.my-10
        a.flex.items-center.mb-10.text-blue-500(:href="`https://github.com/archive-discord/archvie-docs/blob/master/content${this.pageSlug.path}.md`" target="_blank")
...
export default {
    ...
    methods: {
        async getContributors() {
            const {data} = await this.$axios.get(`https://api.github.com/repos/archive-discord/archvie-docs/commits?path=content${this.pageSlug.path}.md`)
            let duplicate = []
